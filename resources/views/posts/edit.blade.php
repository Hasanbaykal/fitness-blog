                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/editPost', array($posts->id)) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea rows="7" id="post_body" class="form-control @error('post_body') is-invalid @enderror" name="post_body" value="{{ $posts->post_body }}" required autocomplete="post_body"></textarea>
